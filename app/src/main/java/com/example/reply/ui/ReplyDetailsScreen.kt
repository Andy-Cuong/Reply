...
//                        .padding(horizontal = dimensionResource(R.dimen.detail_card_outer_padding_horizontal))
                        .apply {
                            if (isFullscreen) {
                                padding(horizontal = dimensionResource(id = R.dimen.detail_card_outer_padding_horizontal))
                            } else {
                                padding(end = dimensionResource(id = R.dimen.detail_card_outer_padding_horizontal))
                            }
                        }
                )
            }
