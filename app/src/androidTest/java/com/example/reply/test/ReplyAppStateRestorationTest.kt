...
class ReplyAppStateRestorationTest {
    ...
    @Test
    @TestCompactWidth
    fun compactDevice_afterConfigChange_selectedEmailRetained() {
        // Use StateRestorationTester to test for a configuration change
    ...
    @Test
    @TestExpandedWidth
    fun expandedDevice_afterConfigChange_selectedEmailRetained() {
        // Use StateRestorationTester to test for a configuration change
        val stateRestorationTester = StateRestorationTester(composeTestRule)
        stateRestorationTester.setContent {
            ReplyApp(windowSize = WindowWidthSizeClass.Medium)
